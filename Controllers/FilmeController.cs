...
namespace ProjetoCinema.Controllers
{
    public class FilmeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FilmeNome,Idade,SesssaoHora")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FilmeNome,Idade,SesssaoHora")] Filme filme)
        {
            if (id != filme.Id)
            {
                return NotFound();
